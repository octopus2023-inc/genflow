...
class YmlCompose:
    ...
    def __init__(self, yaml_file, function_filename,structured_output_schema_filename):
...
def validate_yaml(
    yaml_file: str,
    functions_filename: str = None,
    structured_output_schema_filename: str = None,
    ...
    for node_data in nodes:
        ...
        if node_type == 'function_call':
            ...
            if not function_name:
                ...
                try:
                    module = importlib.import_module(functions_filename)
                    if not hasattr(module, function_name):
                        raise AttributeError
                except (ImportError, AttributeError):
                    error_msgs.append(f"Function '{function_name}' not found in '{functions_filename}' for node '{node_name}' in YAML file '{yaml_file}'.")
                    validated = False
            ...
            if 'structured_output_schema' in node_data:
                ...
                try:
                    ...
                    error_msgs.append(f"Error importing module {structured_output_schema_filename}: {e}")
                    validated = False
                ...
                for i, tool in enumerate(tools):
                    ...
                    # Check if LANGCHAIN tools are valid
                        ...
                        try:
                            ...
                            error_msgs.append(f"Error importing module {functions_filename}: {e}")
                            validated=False
            ...
            validated_subflow, error_msgs_subflow, sub_flow_node_outputs = validate_yaml(
                yml_file_sub_path, functions_filename, structured_output_schema_filename,
